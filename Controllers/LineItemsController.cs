...
using MIS4200_1045.DAL;
using MIS4200_1045.Models;

namespace MIS4200_1045.Controllers
{
    public class LineItemsController : Controller
    {
        ...
        {
            var lineItem = db.lineItem.Include(l => l.product);
        ...
        public ActionResult Create([Bind(Include = "lineitemID,qtyOrdered,price,productID,orderID")] LineItem lineItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "lineitemID,qtyOrdered,price,productID,orderID")] LineItem lineItem)
        {
            if (ModelState.IsValid)
            {
